...
The report should answer the user's real question with minimal friction: can this product launch now, to what scope, what blocks broader launch, and what proof is missing.
...
- Keep the first section short enough to scan quickly.
...
- When the product handles user data, customer files, uploaded files, AI inputs, AI outputs, or logs, add one short `Data and Privacy Handling Feedback` section. This is evidence for the existing gates, not a legal compliance verdict.
- Do not say the product is legally compliant.
...
- Data/privacy surface, if relevant:
...
## 4. Data And Privacy Handling Feedback

Use this section only when the product handles user data, uploaded files, customer documents, personal information, business-sensitive content, AI inputs, AI outputs, or logs. If it does not, say it is not applicable and why.

- What data or files are involved:
- Where they go:
- Log, access, retention, or deletion evidence:
- Impact on current allowed scope:
- Impact on public launch:
- Proof needed:
...
## 10. Must-Have Before Public Launch
